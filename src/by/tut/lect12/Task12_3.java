...
public class Task12_3 {
    public final static Logger LOGGER = Logger.getLogger(Task12_3.class);
    public static void main(String[] args) {
        try {
            LOGGER.info("Before call say method.");
            compute(1);
            compute(20);
        } catch (Task12_3.MyException e) {
    ...
    public static void compute(int a) throws Task12_3.MyException {
        System.out.println("Вызван метод compute(" + a + ")");
        if (a > 10) {
            throw new Task12_3.MyException(a, "Some message");
        }
